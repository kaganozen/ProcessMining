//http://jsfiddle.net/3tu3s0Lm/

//HTML
<div><p style="float: left;"><img src="http://www.ey.com/ecimages/EY-logo-li.png" height="60px" width="60px"></p>
<font size="5">PROCESS MINING</font>
</div>
<anim><b>Process mining is a process management technique that allows for the analysis of business processes based on event logs. During process mining, specialized data-mining algorithms are applied to event log datasets in order to identify trends, patterns and details contained in event logs recorded by an information system.</b></anim>
...
function roundRect(ctxr, x, y, width, height, radius, fill, stroke) {
  ...
  ctxr.beginPath();
  ctxr.moveTo(x + radius, y);
  ctxr.lineTo(x + width - radius, y);
  ctxr.quadraticCurveTo(x + width, y, x + width, y + radius);
  ctxr.lineTo(x + width, y + height - radius);
  ctxr.quadraticCurveTo(x + width, y + height, x + width - radius, y + height);
  ctxr.lineTo(x + radius, y + height);
  ctxr.quadraticCurveTo(x, y + height, x, y + height - radius);
  ctxr.lineTo(x, y + radius);
  ctxr.quadraticCurveTo(x, y, x + radius, y);
  ctxr.closePath();
  if (stroke) {
    ctxr.stroke();
  }
...
function drawrectP121() {
  ctx.rect(600, 320, 10, 50);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawrectP212() {
  ctx.rect(760, 150, 10, 50);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawrectP411() {
  ctx.rect(450, 150, 10, 50);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawcurvedrect() {
 ctxr.roundRect(5, 5, 50, 50);
...
function drawRect2(point, color) {  
  ctx.beginPath();
  ctx.arc(point.z, point.j, 10, 0, 2 * Math.PI);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawRect3(point, color) {
  ctx.beginPath();
  ctx.arc(point.w, point.q, 10, 0, 2 * Math.PI);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawRect4(point, color) {
  ctx.beginPath();
  ctx.arc(point.a, point.b, 10, 0, 2 * Math.PI);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawRect5(point, color) {
  ctx.beginPath();
  ctx.arc(point.e, point.f, 10, 0, 2 * Math.PI);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
...
function drawRect6(point, color) {
  ctx.beginPath();
  ctx.arc(point.g, point.h, 10, 0, 2 * Math.PI);
  ctx.lineWidth = 2;
  ctx.fillStyle = "black";
  ctx.fill();
  ctx.strokeStyle = 'black';
